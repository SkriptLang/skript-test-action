...
skript_repo_directory = Path("/skript")
test_script_directory = skript_repo_directory / os.environ['INPUT_TEST_SCRIPT_DIRECTORY']
...
skript_repo_path = skript_repo_directory / "skript"
...
if extra_plugins_directory_string is not None and extra_plugins_directory_string != "":
    extra_plugins_directory = skript_repo_directory / extra_plugins_directory_string
